...
function Form() {
    ...
    return (
        <div className=' mt-3 container'>
            ...
            <ShowTable addContact={addContact} setAddContact={setAddContact} toggle={toggle} setToggle={setToggle} EditItem={EditItem} editItemKey={editItemKey} />
